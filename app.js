...
const providerUrl = 'https://mainnet.infura.io/v3/6da4e973f4ce4bfa905fca9323610818'; // Replace with your Infura project ID
...
const metadataBaseUrl = 'https://hollywoodpunks.mypinata.cloud/ipfs/QmRgK13azyKTXbaaW5yhFxqtpEUPZje9zPTxEhVBqAAKSg/';

// API endpoint to check if an NFT is minted and return metadata if true
app.get('/checkNFT/:nftId', async (req, res) => {
